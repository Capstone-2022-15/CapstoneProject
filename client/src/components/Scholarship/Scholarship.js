...
export const Scholarship =() =>{
  ...
  const scholarshipData = require('./ScholarshipData.json');
      ...
      <TableContainer component={Paper}>
        <div style={{fontSize:'2rem', marginBottom:"40px", fontWeight:"bold"}}>
          ...
          <Table aria-label='simple table'style={{textalign:'center'}} >
              ...
              <TableBody>
                {scholarshipData.scholarshipData.map((n,index)=>
    ...
    <Box justifyContent={"center"} alignItems="center" display={"flex"}
      ...
      <Stack spacing={2} >
      <Pagination count={parseInt(scholarshipData["scholarshipData"].length/10)+1} page={page} onChange={handleChange} color = "primary" />
    </Stack>
    </Box>
  </div>
    )
